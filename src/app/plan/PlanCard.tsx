...
export default function PlanCard({ plan, isCurrentPlan, isLoggedIn, isPopular = false }: PlanCardProps) {
  ...
  const handleSubscribe = async () => {
    if (!isLoggedIn) {
      window.location.href = '/signin?callbackUrl=/plan';
      return;
    }
  ...
  return (
    <div className={`relative bg-[#1c1d1f] rounded-2xl p-6 border-2 transition-all duration-300 hover:scale-105 ${
      isPopular 
